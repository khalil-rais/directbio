<?php
// DirektbioMailService.php
 
namespace Drupal\direktbio ;
use PHPMailer\PHPMailer\PHPMailer;
 
class DirektbioMailService
{
	...
	public function _notification_mail_smtp ($to_address,$to_cc=null,$body,$subject,$path=null,$filename=null ) {
		...
		// 2 = messages only
		$mail->Username   = "eglantine@prointernetsolutions.com";     // SMTP server username
		$mail->Password   = "SGw4vOucrHmRiSd_";            // SMTP server password
		$mail->SMTPSecure   = "tls"; // option
		//$mail->IsSendmail();  // tell the class to use Sendmail		
		
		$mail->AddReplyTo("eglantine@prointernetsolutions.com","Direkt Bio");
		$mail->From       = "eglantine@prointernetsolutions.com";
		$mail->FromName   = "Direkt Bio";
		$mail->addCC('eglantine@prointernetsolutions.com', 'Direkt Bio');
